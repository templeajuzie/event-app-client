  ...
  return (
    ...
    >
      <View className="relative">
        ...
        <View className="absolute flex flex-col gap-4 top-4 right-2">
          <View style={styles.socialBarSection}>
            <TouchableOpacity className="flex flex-row items-center justify-center p-2 rounded-md bg-gray-200">
              <Svg
                width="20px"
                height="20px"
      ...
      <View className="px-2 mt-2 ">
        <Text className="text-gray-800 font-semibold line-clamp-1 mb-2">
          {title}
        </Text>
      </View>
      <View className="flex flex-row items-center px-2">
        <View className="mr-2">
          <Text className="text-blue-700 font-bold text-md">
            ${price.toFixed(2)}
          </Text>
        </View>
        <View>
